...
dev3:
	rebar3 as dev3 release && _build/dev3/rel/faxe/bin/faxe

dev4:
	rebar3 as dev4 release && _build/dev4/rel/faxe/bin/faxe

dev5:
	rebar3 as dev5 release && _build/dev5/rel/faxe/bin/faxe
