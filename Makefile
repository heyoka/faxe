...
#	export FAXE_CONN_STATUS_HANDLER_MQTT_PORT=9876 && \
	...
	export FAXE_HTTP_API_JWT_PUBLIC_KEY_FILE=/home/heyoka/workspace/faxe/certs/keycloak_jwt_rsa_public.pe && \
...
#	export FAXE_DEBUG_HANDLER_MQTT_HOST=10.156.15.11 && \
	...
	export FAXE_REPORT_DEBUG_MQTT_HOST=mqtt.datahub.tgw-group.cloud && \
